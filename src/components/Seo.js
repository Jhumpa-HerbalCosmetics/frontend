...
const defaultMeta = {
    title: 'Jhumpa Herbal Cosmetics',
    siteName: 'Jhumpa',
    description: 'ayurvedic Jhumpa herbal cosmetics',
    url: 'https://jhumpaherbal.com/',
    type: 'website',
    robots: 'follow, index',
    /**
        ...
        <Head>
            ...
            {meta.date && (
                <>
                    ...
                    <meta name='author' property='article:author' content='Jhumpa Herbal Cosmetics' />
                </>
            )}
