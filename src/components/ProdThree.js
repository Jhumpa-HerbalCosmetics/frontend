...
function ProdThree() {
  return (
    <div className="pb-10 md:pt-0 md:pb-40">
      <div className="w-[90vw] h-fit grid grid-cols-1 md:grid-cols-2 gap-x-20 gap-y-10 mx-auto rounded-3xl border-solid border-white border-2 products lg:pl-4 lg:pr-12 px-2 py-10 xl:py-24">
